...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('static/admin/plugins/morris/morris.css')}}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{asset('static/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
  <!-- Date Picker -->
...
<script src="{{asset('static/admin/plugins/morris/morris.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{asset('static/admin/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('static/admin/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
...
<!-- Slimscroll -->
<script src="{{asset('static/admin/plugins/slimScroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
